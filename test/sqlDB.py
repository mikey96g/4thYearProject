...
#Database Access
cnxn = pyodbc.connect('Driver={ODBC Driver 13 for SQL Server};Server=tcp:year4bitcoin.database.windows.net,1433;Database=year4Proj;Uid=mikey96g@year4bitcoin;Pwd={Tallaght123!};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;')
cursor = cnxn.cursor()
...
def sent_Avg():
    ...
    cursor.execute("INSERT INTO dbo.sentimentValues (sentVal,dt) values(?,?)", avg, currentDT)
    cnxn.commit()
