...
app.layout = html.Div(
    ...
    html.Hr(),
    html.Div(className='row', children=[html.Div(dcc.Graph(id='live-graph', animate=False),className='col s12 m8 l6'),
                                        html.Div(dcc.Graph(id='versus-graph', animate=False), className='col s12 m4 l6')]),
    html.Div(className='row',children= [html.Div(dcc.Graph(id='price-graph', animate=False), className='col s12 m8 l6')]),

    html.Hr(),
    html.Div([html.Button('Click for LSTM', id='button'),
